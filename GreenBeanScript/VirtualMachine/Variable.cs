...
namespace GreenBeanScript.VirtualMachine
{
    public class Variable : IEquatable<Variable>
    {
        ...
        {
            get { return Type == VariableType.String; }
        }

        public bool IsInt
        {
            get { return Type == VariableType.Integer; }
        }

        public bool IsFloat
        {
            get { return Type == VariableType.Float; }
        }
        ...
        public bool IsNull
        {
            get { return Type == VariableType.Null; }
        }
